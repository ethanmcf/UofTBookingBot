...
class RunPage(BasePage):
    def __init__(self):
        ...
        # Run Button
        self.form_layout.addStretch() # Pushes button to bottom
    ...
    def createLoading(self):
        ...
        self.movie = QMovie('app/frontend/assets/loading.gif')
    ...
    def createTimePicker(self):
        ...
        self.time_picker.setStyleSheet(f"""
            ...
            QTimeEdit::up-arrow {{
                image: url(app/frontend/assets/chevron-up.svg);
                width: 12px;
                height: 12px;
            }}
            QTimeEdit::down-arrow {{
                image: url(app/frontend/assets/chevron-down.svg);
                width: 12px;
                height: 12px;
                left: 0px;
            }}   
    ...
    def createDropDown(self):
        ...
        self.sport_dropdown.addItems(["Select ...", "Golf", "Basketball", "Soccer"])
